...
fun1 <- function(idx){
  ...
  conditions <- read_csv(file = 'conditions/try/test_pb_str_orb_str_k_15.csv')
...
clusterEvalQ(cl, source("r_scripts/biased_metas_gen_with_pets.R"))
...
clusterEvalQ(cl, source("r_scripts/orb.R"))
clusterEvalQ(cl, source("r_scripts/pb.R"))
clusterEvalQ(cl, source("r_scripts/pb_orb.R"))
clusterEvalQ(cl, source("r_scripts/prob_inclusion.R"))
