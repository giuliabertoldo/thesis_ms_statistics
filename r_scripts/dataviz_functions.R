...
# Visualize rejection rates (across k, select only one su = sv)
...
# Visualize rejection rates (across su=sv, select only one k)
viz_rejection_rage_su_sv <- function(df, num_studies, bias_type, d, su, sv, ss){
